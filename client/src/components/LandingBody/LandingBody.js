      ...
      >
        ...
        <div className="carousel-inner" role="listbox">
          ...
          <div className="carousel-item imageSpace">
            ...
            <div className="card-img-overlay">
              <div className="card-header">
                <h1 className="cardHeading title2"> T e a c h </h1>
              </div>
              <br />
          ...
          <div className="carousel-item imageSpace">
            ...
            <div className="card-img-overlay">
              <div className="card-header">
                <h1 className="cardHeading title3"> T e a c h </h1>
              </div>
              <br />
          ...
          <div className="carousel-item imageSpace">
            ...
            <div className="card-img-overlay">
              <div className="card-header">
                <h1 className="cardHeading title4"> Safe </h1>
              </div>
              <br />
              <p className="card-text text4">
                All turtors and students have a background verification.
              </p>
              <br />
            </div>
          </div>
